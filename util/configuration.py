...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        # Data parameters
        parser.add_argument('--static_root', help='Static training data root', default='')
        parser.add_argument('--bl_root', help='Blender training data root', default='')
        parser.add_argument('--yv_root', help='YouTubeVOS data root', default='')
        parser.add_argument('--davis_root', help='DAVIS data root', default='')
